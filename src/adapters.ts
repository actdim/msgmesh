...
type ToMsgStructSource<
    TService,
    TPrefix extends string,
    TSkip extends keyof TService = never,
> = Filter<ToUpper<AddPrefix<Skip<TService, TSkip>, TPrefix>>, Func>;

export type ToMsgStruct<
    TService,
    TPrefix extends string,
    TSkip extends keyof TService = never,
...
export function getMsgChannelSelector<TTPrefix extends string>(services: Record<TTPrefix, any>) {
