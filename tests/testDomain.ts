...
export const createTestMsgBus = (config?: MsgBusConfig<MsgStructNormalized<TestBusStruct>>) =>
    createMsgBus<TestBusStruct>(config);

export type TestMsgChannels<TChannel extends keyof TestBusStruct | Array<keyof TestBusStruct>> =
